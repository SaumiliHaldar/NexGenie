  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (isCourseQuery) {
        ...
        const botMessages: Message[] = response.data.fulfillmentMessages.map((msg: any) => ({
          ...
          <div className="messages">
            {messages.map((msg, index) => (
              <div key={index} className={`message ${msg.sender}`}>
                ...
                <div className={`bg-gray-200 chat-bubble ${msg.sender}`} dangerouslySetInnerHTML={{ __html: msg.text }} />
